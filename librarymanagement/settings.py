...
SECRET_KEY = '!f)lt@!7w$pa^c)rzn(@xe2xa97t1%2aa=+m2p_o%^%jvyb9$h'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'parvathics19995@gmail.com'  #from email id
EMAIL_HOST_PASSWORD = 'wucmuitmykgchney'       #App Password
